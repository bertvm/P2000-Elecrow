...
// Cap ArduinoJson heap growth so a large or hostile API body cannot exhaust
// RAM needed by Wi-Fi and the RGB framebuffer. Deserialize from the HTTP
// stream instead of buffering the whole payload in a String.
